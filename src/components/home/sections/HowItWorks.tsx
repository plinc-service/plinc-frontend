...
import { howIstWorkSlideData } from "@/constants/HowItsWorkSlide";
    ...
    <section className="bg-white w-full">
      <div className="container pt-11 pb-16">
        ...
        <div className="flex items-center justify-center gap-20 mt-16">
          <div>
            {howIstWorkSlideData.map((slide, index) => (
              <div
                key={index}
          ...
          <div className="relative">
            ...
            <div className="absolute top-[50%] -translate-y-[50%] -translate-x-[50%] left-[50%] w-[90%] h-[96%] overflow-hidden rounded-[35px]">
              <Image
                src={howIstWorkSlideData[selectedSlide].image}
                alt={howIstWorkSlideData[selectedSlide].title}
                fill
