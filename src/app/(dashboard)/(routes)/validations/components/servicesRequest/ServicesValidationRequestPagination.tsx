...
interface ServicesValidationRequestPaginationProps<TData> {
	page: number;
	totalPages: number;
	onPreviousPage: () => void;
	onNextPage: () => void;
...
const ServicesValidationRequestPagination = <TData,>({
	page,
	totalPages,
	onPreviousPage,
	onNextPage,
	onPageChange,
	data,
}: ServicesValidationRequestPaginationProps<TData>) => {
...
export default ServicesValidationRequestPagination